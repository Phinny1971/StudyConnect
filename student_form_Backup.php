 ...
 <!-- Tab 5 -->
    <div class="tab">
      ...
      <div class="edu-section">
		...
		<table>
			...
			<td style="vertical-align: top; height:25px;"><input type="text" id="university" placeholder="University Name" style="height:25px;"></td>
			<td style="vertical-align: top; height:25px;"><input type="text" id="course" placeholder="Course Name"  style="height:25px; "></td>
			<td style="vertical-align: top; height:25px;"><input type="url" id="url" placeholder="Course URL" style="height:25px; ">     </td>
    ...
    <input type="hidden" name="courses" id="coursesInput">
		...
		<table style=" border-collapse: collapse; width: 100%; margin-top: 20px;">
			<thead>
				<tr style='height:15px; padding: 1px; border: 1px solid #ccc; text-align: left; position: relative; background-color: lightgrey;'><th style='height:25px; padding: 1px; border: 1px solid #ccc; text-align: left; position: relative;'>University</th><th style='height:25px; padding: 1px; border: 1px solid #ccc; text-align: left; position: relative;'>Course</th><th style='height:25px; padding: 1px; border: 1px solid #ccc; text-align: left; position: relative;'>URL</th><th style='height:25px; padding: 1px; border: 1px solid #ccc; text-align: left; position: relative;'>Actions</th></tr>
			</thead>
